...
截至 `2026-05-19`，fresh 验证还包括：

- `cargo test` 全量通过，270 个测试通过
- 其中 `application_use_cases` 22、`failure_modes` 31、`mcp_stdio` 36、`sqlite_store` 20、`dashboard_http` 7、`support_bundle` 32、`status_sync` 3
