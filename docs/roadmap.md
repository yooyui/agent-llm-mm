...
- Packaging preflight 现在要求四个平台 archive 与 `packaging-archive-manifest.json` 的 size / SHA-256 匹配；archive evidence runner 只哈希已存在文件，不构建二进制、installer、service manager、auto-updater、上传或 tag
