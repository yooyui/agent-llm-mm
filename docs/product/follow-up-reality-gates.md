...
- `partial`: the MCP interface now has scoped Event/Claim search and get slices
  plus exact Claim-linked reflection history. Identity/commitment history,
  record-only reflections, episode/reflection lookup, and audited
